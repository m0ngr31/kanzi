...
@ask.intent('Shutdown')
def alexa_shutdown():
  response_text = render_template('are_you_sure__shutdown').encode("utf-8")
...
@ask.intent('Reboot')
def alexa_reboot():
  response_text = render_template('are_you_sure__reboot').encode("utf-8")
...
def alexa_hibernate():
  response_text = render_template('are_you_sure__hibernate').encode("utf-8")
...
@ask.intent('Suspend')
def alexa_suspend():
  response_text = render_template('are_you_sure__suspend').encode("utf-8")
